...
# Legend labels
legend_labels <- lapply(group_vars, function(var) levels(data[[var]]))
...
# Generate plots (NO risk table)
km_plots <- mapply(function(model, title, legend_title, legend_lab) {
...
png("~/Dropbox/MyProject/TLCR/KM_6plots_final_norisktable.png", width = 10, height = 10, units = "in", res = 300)
...
pdf("~/Dropbox/MyProject/TLCR/KM_6plots_final_norisktable.pdf", width = 10, height = 10)
grid.arrange(grobs = km_plots, ncol = 2, nrow = 3)
dev.off()
